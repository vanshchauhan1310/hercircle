...
type Role = 'customer' | 'pharmacy' | 'distributor' | 'admin';
...
export default function LoginScreen() {
  ...
  const handlePrimaryAction = () => {
    if (!email || !password) {
      Alert.alert('Missing Info', 'Please enter both email/phone and password.');
      return;
    }
      ...
      <KeyboardAvoidingView
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            The all-in-one platform for pharmaceutical distribution.
          </Text>
        </View>
